...
class CoordinatePicker extends CWidget
{
    ...
    public function run()
    {
        ...
        if (!isset($this->label)) $this->label = '<img src="'. $this->assets.'/images/map_pick.png"/>';

        echo CHtml::link($this->label, '#', array('id' => $this->getId(),'title' =>'click here to locate in maps'));
